...
export function reduceActivities(items, selectedActivityTypes, selectedFilters) {
  /**
...
export const reduceActivitiesFinal = (selectedLanguages, selectedActors, filteredActivities) => {
  /**
