...
export const selectActivities = (activityIds, activities, selectedActivityTypes, selectedFilters) => {
  /**
...
export const selectActivitiesFinal = (selectedLanguages, selectedActors, activities, filteredActivities) => {
  /**
