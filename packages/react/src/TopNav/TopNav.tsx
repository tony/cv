...
export const TopNav: React.FC = () => (
  <nav
    id="top-nav"
    className="sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] bg-blue-800/90 text-white supports-backdrop-blur:bg-white/60 dark:bg-black-pearl-700/20"
  >
