...
export const FWChartSourceURLMapping: FWChartRecord = {
  [Framework.React]: {
    [Chart.CarbonCharts]: `${projectBranchPrefixUrl}${
      ChartBranchMapping[Chart.CarbonCharts]
    }`,
    [Chart.Plotly]: `${projectBranchPrefixUrl}${
      ChartBranchMapping[Chart.Plotly]
    }`,
    [Chart.BillboardNext]: `${projectBranchPrefixUrl}${
      ChartBranchMapping[Chart.BillboardNext]
    }`,
    [Chart.Billboard]: `${projectBranchPrefixUrl}${
      ChartBranchMapping[Chart.Billboard]
    }`,
    [Chart.ReactVis]: `${projectBranchPrefixUrl}${
      ChartBranchMapping[Chart.ReactVis]
    }`,
    [Chart.Victory]: `${projectBranchPrefixUrl}${
      ChartBranchMapping[Chart.Victory]
    }`,
...
export const FWChartURLMapping = Object.values(Framework).reduce(
  (urlMapping, framework) => {
