...
import type { LineSeries, LineSeriesPoint, RadialChart } from "react-vis";
...
import type { FlexRadialChart } from "./charts";
...
export class VisChartQuery extends CVQuery {
  ...
  subDonutChart$(): Observable<DonutChartProps> {
    return combineQueries([
      ...
      map(([bgColorMap, languageMap, languages, visibleActivities]) => {
        return {
