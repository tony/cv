      ...
      <div className="row lenses">
        ...
        >
          <Select
            ...
            value={
              this.props.selectedActors.length ? this.props.selectedActors : ''
            }
          ...
          <Select
            ...
            value={
              this.props.selectedActivityTypes.length
                ? this.props.selectedActivityTypes
                : ''
            }
          ...
          >
            {Object.keys(this.props.filters).map((filterChoice) => (
              <div className="col-sm" key={filterChoice}>
                <div className="box">
...
export default connect(mapStateToProps, mapDispatchToProps)(Lenses);
